...
import { CustomPieChart, CustomLineChart } from "../Charts";
    ...
    session && (
      <div className="grid h-full min-h-screen w-screen grid-cols-1 overflow-hidden bg-customGray xl:grid-cols-[18rem_auto] xl:p-8">
        ...
        <div className="flex flex-col gap-6 px-6 py-6 xl:ml-10 xl:gap-10">
          {/* Header */}
          <div className="sticky left-0 top-0 flex items-center justify-between gap-x-7 py-6 xl:static xl:p-0 ">
            <Icon
              name={"hamburger"}
          ...
          {/* Another Two Cards */}
          <div className="grid grid-cols-1 grid-rows-2 gap-6 md:grid-cols-2 md:grid-rows-1 xl:gap-10">
